...
def render_header(title, logo_width=70):
    ...
    with col1:
        st.image("docs/logo.png", width=logo_width)

    with col2:
        st.title(title)

#  Quick navigation links to all app pages 
...
# Display prediction for next period 
...
# Return color depending on symptom intensity
...
# Message shown when no symptoms exist for today
...
# Display today's tracked symptoms
